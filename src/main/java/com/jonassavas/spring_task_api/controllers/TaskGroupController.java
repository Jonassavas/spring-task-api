...
public class TaskGroupController {
    ...
    public ResponseEntity<TaskGroupDto> createTaskGroup(
            @PathVariable Long boardId, @Valid @RequestBody CreateTaskGroupRequestDto requestDto) {
    ...
    @GetMapping
    public ResponseEntity<List<TaskGroupDto>> listTaskGroups(@PathVariable Long boardId) {

        List<TaskGroupDto> groups = taskGroupService.listGroupsOnBoard(boardId);

        return ResponseEntity.ok(groups);
    }

    @GetMapping("/{groupId}")
    public ResponseEntity<TaskGroupWithTasksDto> getGroupWithTasks(@PathVariable Long groupId) {

        TaskGroupWithTasksDto dto = taskGroupService.findByIdWithTasks(groupId);

        return ResponseEntity.ok(dto);
    }

    @PatchMapping("/reorder")
    public ResponseEntity<Void> reorderTaskGroups(
            @PathVariable Long boardId,
            @Valid @RequestBody ReorderTaskGroupsRequestDto requestDto) {

        taskGroupService.reorderTaskGroups(boardId, requestDto);
    ...
    public ResponseEntity<TaskGroupDto> updateTaskGroup(
            @PathVariable Long groupId, @Valid @RequestBody UpdateTaskGroupRequestDto requestDto) {
    ...
    public ResponseEntity<Void> deleteTaskGroup(@PathVariable Long groupId) {
    ...
    public ResponseEntity<Void> deleteAllTasks(@PathVariable Long groupId) {
