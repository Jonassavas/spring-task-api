...
public class TaskServiceImpl implements TaskService {
    ...
    public TaskDto createTask(Long groupId, CreateTaskRequestDto taskRequestDto) {
        ...
        TaskEntity taskEntity = TaskEntity.builder().taskName(taskRequestDto.getTaskName()).build();
    ...
    public TaskDto update(Long id, UpdateTaskRequestDto taskRequestDto) {
        ...
        if (taskRequestDto.getTaskGroupId() != null
            ...
            TaskGroupEntity newGroup =
                    taskGroupRepository
                            .findByIdAndTaskBoardOwnerUsername(
                                    taskRequestDto.getTaskGroupId(), username)
                            .orElseThrow(
                                    () ->
                                            new EntityNotFoundException(
