...
public class UserControllerIntegrationTest extends BaseControllerIntegrationTest {
        ...
        public void testThatGetCurrentUserReturnsUser() throws Exception {
                mockMvc.perform(
                                authenticated(MockMvcRequestBuilders.get("/users/me"))).andExpect(
        ...
        public void testThatDeleteUserReturns204() throws Exception {
                mockMvc.perform(
                                authenticated(MockMvcRequestBuilders.delete("/users/me"))).andExpect(
        ...
        public void testThatRequestWithoutTokenReturns401() throws Exception {
                mockMvc.perform(
                                MockMvcRequestBuilders.patch("/users/me")).andExpect(
                                                MockMvcResultMatchers.status().isUnauthorized());
        }
        ...
        public void testThatDeletingUserAlsoDeletesAssociatedTaskData() throws Exception {
                ...
                UserEntity testUser = userRepository.saveAndFlush(TestUserData.createBaseTestUserEntity("cascadeUser"));
                String userToken = jwtService.generateToken(testUser.getUsername());

                TaskBoardEntity board = taskBoardRepository
                                .save(TestTaskBoardData.createTestTaskBoardEntityA(testUser));
                TaskGroupEntity group = taskGroupRepository.save(TestTaskGroupData.createTaskGroupEntityA(board));
        ...
        public void testThatDeleteUserCascadesAndBlocksAccess() throws Exception {
                ...
                UserEntity cascadeUser = userRepository.saveAndFlush(
                ...
                TaskBoardEntity board = taskBoardRepository.save(
                                TestTaskBoardData.createTestTaskBoardEntityA(cascadeUser));

                TaskGroupEntity group = taskGroupRepository.save(
                                TestTaskGroupData.createTaskGroupEntityA(board));
